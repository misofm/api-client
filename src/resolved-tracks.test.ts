...
const track = { no: "1", title: "Song", recordingId: "0x1", compositionId: "0x2", splitBps: 10000, disc: 1 };
...
test("supports unavailable objects and older deployments", () => {
  expect(trackViewSchema.parse({ ...track, recording: null, composition: null }).recording).toBeNull();
